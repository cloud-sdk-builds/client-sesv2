...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MS1kmb2QZsv2adhmLdSYbauUUuMZDxmqFqcwuC6j0V2mzhEOC4ITzZNNywP/p677
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.445.0/index.min.mjs": "sha384-MS1kmb2QZsv2adhmLdSYbauUUuMZDxmqFqcwuC6j0V2mzhEOC4ITzZNNywP/p677"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.445.0/LICENSE
```

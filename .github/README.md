...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+w+w60uCE2OhC2E0vuRVHjZS1s96/CW/wAwpA9YLMMHETCcaASLas6rbdKr6H1/Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.485.0/index.min.mjs": "sha384-+w+w60uCE2OhC2E0vuRVHjZS1s96/CW/wAwpA9YLMMHETCcaASLas6rbdKr6H1/Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.485.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PyBlW45VoNUgZOLzEjisk6DUEt8L/oWcCfp5RjwpTyOFSbOOl5r4Vq6VvfzTdJnS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.830.0/index.min.mjs": "sha384-PyBlW45VoNUgZOLzEjisk6DUEt8L/oWcCfp5RjwpTyOFSbOOl5r4Vq6VvfzTdJnS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.830.0/LICENSE
```

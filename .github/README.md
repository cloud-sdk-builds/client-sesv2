...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eDU4dYDPJQZD/+A9REYF3MtgU3bFrV23xXkurobUopyjNMVREwLcDNzeKV1eQfJK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.29.0/index.min.mjs": "sha384-eDU4dYDPJQZD/+A9REYF3MtgU3bFrV23xXkurobUopyjNMVREwLcDNzeKV1eQfJK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.29.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QGR7gAyAP2Zwzjuyj/IZL2eCzW6tY2zEju5JBIZkcV/+F2yW3B3Kr56fo/cF6b8B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.947.0/index.min.mjs": "sha384-QGR7gAyAP2Zwzjuyj/IZL2eCzW6tY2zEju5JBIZkcV/+F2yW3B3Kr56fo/cF6b8B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.947.0/LICENSE
```

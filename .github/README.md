...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-76wRJ2fUkiR+vdn7iI86x3rwHRduw+yLWUhdWBXVjTLlIH0mGLtrBGBRO3L8ktPP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.823.0/index.min.mjs": "sha384-76wRJ2fUkiR+vdn7iI86x3rwHRduw+yLWUhdWBXVjTLlIH0mGLtrBGBRO3L8ktPP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.823.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gLlzqBpxZByncioSDL1ss6PaxqXYd8nQvDP+JPgM7taCbx15a4BCUfesH0yys4dK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.919.0/index.min.mjs": "sha384-gLlzqBpxZByncioSDL1ss6PaxqXYd8nQvDP+JPgM7taCbx15a4BCUfesH0yys4dK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.919.0/LICENSE
```

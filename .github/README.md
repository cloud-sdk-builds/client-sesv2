...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V2dur5/2s2GzLm2VXSTEMXCULYFoWmNJQ9LyOvKLrM+T4AVs4jr4wcGfCobT4o3I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.118.0/index.min.mjs": "sha384-V2dur5/2s2GzLm2VXSTEMXCULYFoWmNJQ9LyOvKLrM+T4AVs4jr4wcGfCobT4o3I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.118.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nRMda0xWRxg8j8xJEuhk+p8QzXfVwnsDkX9s/MieGF7/AUqRhpAA2F9Fj0zD2epp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.908.0/index.min.mjs": "sha384-nRMda0xWRxg8j8xJEuhk+p8QzXfVwnsDkX9s/MieGF7/AUqRhpAA2F9Fj0zD2epp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.908.0/LICENSE
```

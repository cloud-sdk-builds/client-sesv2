...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wsotn1xvU2BBoaOA5CJrSbu6Qxi0aTs0GhHuJTf49+A3+Y8VtfmdqX379jT4s0LE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.39.0/index.min.mjs": "sha384-wsotn1xvU2BBoaOA5CJrSbu6Qxi0aTs0GhHuJTf49+A3+Y8VtfmdqX379jT4s0LE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.39.0/LICENSE
```

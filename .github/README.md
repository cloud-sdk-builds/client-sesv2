...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hynB1Yxf5YenOLbz83lKIeN9qXUR8paBU+KIqu9qomE1+18fLAEvdjlKjMqJLmtc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.714.0/index.min.mjs": "sha384-hynB1Yxf5YenOLbz83lKIeN9qXUR8paBU+KIqu9qomE1+18fLAEvdjlKjMqJLmtc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.714.0/LICENSE
```

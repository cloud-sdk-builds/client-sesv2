...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2NmJLpirSdy5n/pNW1eaNC9ZqDud40Rous+F3FD3MDseaPmTsJcUAqvIVqZovZE+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.966.0/index.min.mjs": "sha384-2NmJLpirSdy5n/pNW1eaNC9ZqDud40Rous+F3FD3MDseaPmTsJcUAqvIVqZovZE+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.966.0/LICENSE
```

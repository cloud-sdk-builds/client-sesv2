...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JTsVpv5uiQpLMC4OMC+shmsCckO9ltXg33RfyjLoRpnZmj5Jbk+z8KI+Q2n/iGkz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.496.0/index.min.mjs": "sha384-JTsVpv5uiQpLMC4OMC+shmsCckO9ltXg33RfyjLoRpnZmj5Jbk+z8KI+Q2n/iGkz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.496.0/LICENSE
```

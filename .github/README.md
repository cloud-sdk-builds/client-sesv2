...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.1.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.1.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hjOvwk4gZr7gku4LFUD3ebeaoHmku02vgnT7y5tSp6Rd+aPnpUOzOzHEZpsGgNiD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.1.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.1.0/index.min.mjs": "sha384-hjOvwk4gZr7gku4LFUD3ebeaoHmku02vgnT7y5tSp6Rd+aPnpUOzOzHEZpsGgNiD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.1.0/LICENSE
```

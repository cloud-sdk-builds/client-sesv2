...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CRnr7WakwhArND5ywRBm6UfMWcSRyqkTlEuJm3TEAFuTyDS9f0z3DfVW/jjMPzJC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.43.0/index.min.mjs": "sha384-CRnr7WakwhArND5ywRBm6UfMWcSRyqkTlEuJm3TEAFuTyDS9f0z3DfVW/jjMPzJC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.43.0/LICENSE
```

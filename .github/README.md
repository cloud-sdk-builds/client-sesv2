...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nxg2tbHP3h2GcV3pxySN/7KcYMhB9lkhTrpMWzjhGJOTd7niQMm+toiynBE+ar1p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.183.0/index.min.mjs": "sha384-nxg2tbHP3h2GcV3pxySN/7KcYMhB9lkhTrpMWzjhGJOTd7niQMm+toiynBE+ar1p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.183.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-skHX+0pxYvwy+HcmYrwWufMSYgzV35DEDh2rTMtwC43l2O+CcGwOc+s3NaHDJoKn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.25.0/index.min.mjs": "sha384-skHX+0pxYvwy+HcmYrwWufMSYgzV35DEDh2rTMtwC43l2O+CcGwOc+s3NaHDJoKn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.25.0/LICENSE
```

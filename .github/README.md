...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zuWqb/2G0m9q0ymF5HxM7gQjNmLnNBSUO4pSBPhVXljkMWZeW4cLwDOgwdHvTKLZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.423.0/index.min.mjs": "sha384-zuWqb/2G0m9q0ymF5HxM7gQjNmLnNBSUO4pSBPhVXljkMWZeW4cLwDOgwdHvTKLZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.423.0/LICENSE
```

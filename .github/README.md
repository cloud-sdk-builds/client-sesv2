...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XYzAIOFpnM+8z7Tk7KiCAq75qJnNtV9zi+fmvZ2EXQQJqkVH7JcXvVP1MthDDCnr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.137.0/index.min.mjs": "sha384-XYzAIOFpnM+8z7Tk7KiCAq75qJnNtV9zi+fmvZ2EXQQJqkVH7JcXvVP1MthDDCnr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.137.0/LICENSE
```

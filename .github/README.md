...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ieRH/rHgkvLfMysH6dfCqJlpnBgni5oXUSAuS4DZVStHOhnGa83+y6z5/R9s67lW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.100.0/index.min.mjs": "sha384-ieRH/rHgkvLfMysH6dfCqJlpnBgni5oXUSAuS4DZVStHOhnGa83+y6z5/R9s67lW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.100.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-owpFkXebRvxrsMe0lZG68KDY9SeiBqZseGHXVlsXwJmHTe+vya6DTxJXvawi5gri
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.970.0/index.min.mjs": "sha384-owpFkXebRvxrsMe0lZG68KDY9SeiBqZseGHXVlsXwJmHTe+vya6DTxJXvawi5gri"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.970.0/LICENSE
```

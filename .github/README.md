...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b+dDn8044rc+OpHXp5UL1Go0LsK4ixAwrzDj6fUaJPDOcYPDL/9/nZvp4/YjZAun
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.160.0/index.min.mjs": "sha384-b+dDn8044rc+OpHXp5UL1Go0LsK4ixAwrzDj6fUaJPDOcYPDL/9/nZvp4/YjZAun"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.160.0/LICENSE
```

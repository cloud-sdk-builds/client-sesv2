...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t69XVRXv6aEHNEMJeMUIsJyIfdwYQCRzfhURxe9QyxURl2RON8QAKnL5b/C6es7v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.677.0/index.min.mjs": "sha384-t69XVRXv6aEHNEMJeMUIsJyIfdwYQCRzfhURxe9QyxURl2RON8QAKnL5b/C6es7v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.677.0/LICENSE
```

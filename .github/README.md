...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5lVyNnQz2LzpaZB9UrY/E+gxkX3w2/XMEb5PjugeBll+3BxcV3DlR83k6ScxL4Md
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.839.0/index.min.mjs": "sha384-5lVyNnQz2LzpaZB9UrY/E+gxkX3w2/XMEb5PjugeBll+3BxcV3DlR83k6ScxL4Md"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.839.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OibqKxgJMs9ccN+zEkHvx6x+p8ckcaE9gHLzmKTfZRz0rgq7RwczOcb/QOjvKH0l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.925.0/index.min.mjs": "sha384-OibqKxgJMs9ccN+zEkHvx6x+p8ckcaE9gHLzmKTfZRz0rgq7RwczOcb/QOjvKH0l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.925.0/LICENSE
```

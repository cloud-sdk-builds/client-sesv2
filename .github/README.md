...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FIzgi5El3iqEcKjl8sXXnFhZHpN8clK/iBDcb9DqGBiiXvHnUcOe1tM9p+zK3GXy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.911.0/index.min.mjs": "sha384-FIzgi5El3iqEcKjl8sXXnFhZHpN8clK/iBDcb9DqGBiiXvHnUcOe1tM9p+zK3GXy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.911.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-lLnIOIk0eDnKOYFrGzpmEWb4U/L/zjtyBIqC/up5OEke+8sPMPcE7KmvJN0Qs+Xe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.726.1/index.min.mjs": "sha384-lLnIOIk0eDnKOYFrGzpmEWb4U/L/zjtyBIqC/up5OEke+8sPMPcE7KmvJN0Qs+Xe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.726.1/LICENSE
```

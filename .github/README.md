...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w9eWFAj9PoGmMZhRZLd0nIAZWsEAgHv7+3+TjVSHo5U+NexS+s9muKDJy4SmKp+k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.2.0/index.min.mjs": "sha384-w9eWFAj9PoGmMZhRZLd0nIAZWsEAgHv7+3+TjVSHo5U+NexS+s9muKDJy4SmKp+k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.2.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yDGQoOe47eqzU+P2J4T4cgb8EI9xAGr8rv8jgCRuyMMmh39/aOp9ZUss9HRsE1zz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.342.0/index.min.mjs": "sha384-yDGQoOe47eqzU+P2J4T4cgb8EI9xAGr8rv8jgCRuyMMmh39/aOp9ZUss9HRsE1zz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.342.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PXukw0bBu5qXbd2AkGXLF4/jhDKYzO3jKh/ZdLnoBMNhw/ouFJcMfb2NmRs0zBZx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.11.0/index.min.mjs": "sha384-PXukw0bBu5qXbd2AkGXLF4/jhDKYzO3jKh/ZdLnoBMNhw/ouFJcMfb2NmRs0zBZx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.11.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.672.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.672.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rBGC7pyLGNtB7dYFCrFTON86gnSvVBOLtfPgIe+1zk5E6cVDYCJBRtOJJVURCbyF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.672.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.672.0/index.min.mjs": "sha384-rBGC7pyLGNtB7dYFCrFTON86gnSvVBOLtfPgIe+1zk5E6cVDYCJBRtOJJVURCbyF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.672.0/LICENSE
```

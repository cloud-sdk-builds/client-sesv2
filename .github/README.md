...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2ta+l6GNjyC5dAafKa7Yo3FKFf3wAit2q8O6A9OlQso17/5U2PxpF4uMMfRw+tCZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.758.0/index.min.mjs": "sha384-2ta+l6GNjyC5dAafKa7Yo3FKFf3wAit2q8O6A9OlQso17/5U2PxpF4uMMfRw+tCZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.758.0/LICENSE
```

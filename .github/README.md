...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FTKEGVwA+nvek07CWq/o26Qwe4an9jHDBIaZziYcP4BYBQhxCIAXojoWSv2VZqF2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.929.0/index.min.mjs": "sha384-FTKEGVwA+nvek07CWq/o26Qwe4an9jHDBIaZziYcP4BYBQhxCIAXojoWSv2VZqF2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.929.0/LICENSE
```

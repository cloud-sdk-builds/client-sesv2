...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gE4+Jcg26u7uzV4+chqpWiqqDguuT5cuRQzxFsgJ8VzgWZZWKBLM7FEemXdbz+1u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.696.0/index.min.mjs": "sha384-gE4+Jcg26u7uzV4+chqpWiqqDguuT5cuRQzxFsgJ8VzgWZZWKBLM7FEemXdbz+1u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.696.0/LICENSE
```

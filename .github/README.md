...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c6C0p452iAi+lwHpPPc58fgS4uDl3TrH3/0Bz5RmcgZqvldcq0cebN+dosbybWAf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.168.0/index.min.mjs": "sha384-c6C0p452iAi+lwHpPPc58fgS4uDl3TrH3/0Bz5RmcgZqvldcq0cebN+dosbybWAf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.168.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.98.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.98.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RQ6MiYFgd7g2nzZnHTKmu4SJkSuyC5/UDVnpu+hCedqxJzW3RiIrsgsccOYY4RL+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.98.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.98.0/index.min.mjs": "sha384-RQ6MiYFgd7g2nzZnHTKmu4SJkSuyC5/UDVnpu+hCedqxJzW3RiIrsgsccOYY4RL+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.98.0/LICENSE
```

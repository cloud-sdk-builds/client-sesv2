...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kSpGdgmK/ldGVh1cotLKy5fCC1GndPZXtPbefO0GNaHNXNK1zcvA+FLyj6LMHYuJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.290.0/index.min.mjs": "sha384-kSpGdgmK/ldGVh1cotLKy5fCC1GndPZXtPbefO0GNaHNXNK1zcvA+FLyj6LMHYuJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.290.0/LICENSE
```

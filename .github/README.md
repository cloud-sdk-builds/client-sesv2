...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HDF/AomiYE76GoC8kG7/5v7XKkFvBn1MJoWCfNXPKkQpuTG+9ud1YlpL//Sphf51
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.387.0/index.min.mjs": "sha384-HDF/AomiYE76GoC8kG7/5v7XKkFvBn1MJoWCfNXPKkQpuTG+9ud1YlpL//Sphf51"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.387.0/LICENSE
```

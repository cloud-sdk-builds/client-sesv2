...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-To4zJkiu68QQdKzjp1fGV2nDTJzLGX1ejuQIGC9f5e7C9Sz3JY+aCyVYfuUkttiN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.292.0/index.min.mjs": "sha384-To4zJkiu68QQdKzjp1fGV2nDTJzLGX1ejuQIGC9f5e7C9Sz3JY+aCyVYfuUkttiN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.292.0/LICENSE
```

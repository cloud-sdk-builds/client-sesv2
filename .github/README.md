...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RikqlRNCCyfewdjrYsjsd53eDSHrTfMP3a6hgorurL9Ds+i4ZHdHtcmTykDA4UUE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.978.0/index.min.mjs": "sha384-RikqlRNCCyfewdjrYsjsd53eDSHrTfMP3a6hgorurL9Ds+i4ZHdHtcmTykDA4UUE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.978.0/LICENSE
```

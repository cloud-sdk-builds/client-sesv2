...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-xYyWH62d0dZcsOHucq1XAizji1TVrINYozK4aM0+f6ugj4lzKyvqQ9HYM5UiQlyq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.347.1/index.min.mjs": "sha384-xYyWH62d0dZcsOHucq1XAizji1TVrINYozK4aM0+f6ugj4lzKyvqQ9HYM5UiQlyq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.347.1/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rq/KQx6KegvPs7T+j/lCNVyB/+cZr2gxy2DxZDNXKeSPyU0yFZ8bA+5vq5RxCfDA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.50.0/index.min.mjs": "sha384-Rq/KQx6KegvPs7T+j/lCNVyB/+cZr2gxy2DxZDNXKeSPyU0yFZ8bA+5vq5RxCfDA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.50.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TihC4lzooFTInddu87yatEGxkChD4T9jluimDEDS4Ljotyl/O5H+JFJM/QA/ZY0o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.224.0/index.min.mjs": "sha384-TihC4lzooFTInddu87yatEGxkChD4T9jluimDEDS4Ljotyl/O5H+JFJM/QA/ZY0o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.224.0/LICENSE
```

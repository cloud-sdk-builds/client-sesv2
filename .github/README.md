...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ry8rwmGbufdErhlEieGPMwoTk6qnvlHdnp/Nd9Ya4SlJtWfg//7wDRWdcsRBPTqN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.726.0/index.min.mjs": "sha384-Ry8rwmGbufdErhlEieGPMwoTk6qnvlHdnp/Nd9Ya4SlJtWfg//7wDRWdcsRBPTqN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.726.0/LICENSE
```

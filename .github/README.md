...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u1dRAaH3VfyadISzaJJ/caKcmexUJ9KrtYGl+rhYUm4ycnRdkiof498kHt8BUexR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.33.0/index.min.mjs": "sha384-u1dRAaH3VfyadISzaJJ/caKcmexUJ9KrtYGl+rhYUm4ycnRdkiof498kHt8BUexR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.33.0/LICENSE
```

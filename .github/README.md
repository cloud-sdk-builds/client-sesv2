...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FnmvR3B6pNlOCoMgvlP/7CyglltNXVkUOnXWsQi1HNC/Prb3BhBfJ707EY9wkdVx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.35.0/index.min.mjs": "sha384-FnmvR3B6pNlOCoMgvlP/7CyglltNXVkUOnXWsQi1HNC/Prb3BhBfJ707EY9wkdVx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.35.0/LICENSE
```

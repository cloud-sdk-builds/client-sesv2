...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rseXZNwqWWzxhkrbNZOKMTVAFwTbHpYx8Gn9hEfa5NieePVx2UZR/8TC3DdfbaCF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.616.0/index.min.mjs": "sha384-rseXZNwqWWzxhkrbNZOKMTVAFwTbHpYx8Gn9hEfa5NieePVx2UZR/8TC3DdfbaCF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.616.0/LICENSE
```

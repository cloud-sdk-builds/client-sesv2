...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tbkBnV6ME5/2rWafKhlPlY7aBQyUCxTeof1sN0tRlCKVwIPEC0w9jiXyB/HQ00o+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.441.0/index.min.mjs": "sha384-tbkBnV6ME5/2rWafKhlPlY7aBQyUCxTeof1sN0tRlCKVwIPEC0w9jiXyB/HQ00o+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.441.0/LICENSE
```

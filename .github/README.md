...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wIhx7nJPScXBp2vLp8LTaqJj0xbJypxsHw8P75yCgvZeEBPXL7rbKYndpHYuVL1L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.32.0/index.min.mjs": "sha384-wIhx7nJPScXBp2vLp8LTaqJj0xbJypxsHw8P75yCgvZeEBPXL7rbKYndpHYuVL1L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.32.0/LICENSE
```

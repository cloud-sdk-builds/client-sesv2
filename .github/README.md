...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RscD81ZvyaEkfteDYMKbC/yHbAzooixpohmIKTwWthbziKdb9eT0en0j/lJe1DGQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.596.0/index.min.mjs": "sha384-RscD81ZvyaEkfteDYMKbC/yHbAzooixpohmIKTwWthbziKdb9eT0en0j/lJe1DGQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.596.0/LICENSE
```

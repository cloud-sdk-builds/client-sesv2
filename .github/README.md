...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gLpym8MP7v2NLwLiquFA54bF0w0ZkZJauqUdNdBRzvFIhAuc6pAqJO+TNpfK/e9X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.425.0/index.min.mjs": "sha384-gLpym8MP7v2NLwLiquFA54bF0w0ZkZJauqUdNdBRzvFIhAuc6pAqJO+TNpfK/e9X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.425.0/LICENSE
```

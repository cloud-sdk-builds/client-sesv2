...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PaU4PE6EqJ/wsOje9mnprDMJJK9VYGSZJJ/jzwdcy2gWF+/ecTGLp8pMMk8ia3fH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.525.0/index.min.mjs": "sha384-PaU4PE6EqJ/wsOje9mnprDMJJK9VYGSZJJ/jzwdcy2gWF+/ecTGLp8pMMk8ia3fH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.525.0/LICENSE
```

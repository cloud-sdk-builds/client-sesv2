...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dUxSlNAVQPX5B/0K6JtrKtB/FhNSnb24lqFKml6hpXMd9jS8hEgd+/Litr507ezr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.691.0/index.min.mjs": "sha384-dUxSlNAVQPX5B/0K6JtrKtB/FhNSnb24lqFKml6hpXMd9jS8hEgd+/Litr507ezr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.691.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oCyiLgvtMPg7Yi7FrQ6LDzp12xeTtpTMOYwt97oJlhg7n0NiyLPrg+SAbjRnzCN0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.5.0/index.min.mjs": "sha384-oCyiLgvtMPg7Yi7FrQ6LDzp12xeTtpTMOYwt97oJlhg7n0NiyLPrg+SAbjRnzCN0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.5.0/LICENSE
```

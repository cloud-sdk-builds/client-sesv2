...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZFLAUX8AP0ABIYNnrbtbXM/2BlHjN4U0nIsELppfLDGko4DSfLqWIMFs3jlJBocy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.0.0/index.min.mjs": "sha384-ZFLAUX8AP0ABIYNnrbtbXM/2BlHjN4U0nIsELppfLDGko4DSfLqWIMFs3jlJBocy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.0.0/LICENSE
```

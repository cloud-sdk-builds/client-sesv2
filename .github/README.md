...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J1iRgOtI5m/cJLgp0AYoPN+sDgoUg5XBEWQCjJYGwekSW/xlc2o5yiPAplySLJsD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.54.0/index.min.mjs": "sha384-J1iRgOtI5m/cJLgp0AYoPN+sDgoUg5XBEWQCjJYGwekSW/xlc2o5yiPAplySLJsD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.54.0/LICENSE
```

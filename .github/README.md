...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-artnS7C4R+tkQy6NyrmaDk5aae6dl1onJtzQc0MUEMOhl+L076Mmaz4UqgqTlfMs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.79.0/index.min.mjs": "sha384-artnS7C4R+tkQy6NyrmaDk5aae6dl1onJtzQc0MUEMOhl+L076Mmaz4UqgqTlfMs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.79.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Y4TLPNNuZ3d20mk8fD1Y5+zVlVtfkUsPqzdL/l8H+GrhDT/31KRSHEMceV3my9Ez
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.686.0/index.min.mjs": "sha384-Y4TLPNNuZ3d20mk8fD1Y5+zVlVtfkUsPqzdL/l8H+GrhDT/31KRSHEMceV3my9Ez"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.686.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pQE4xS5LvdYzlB+x1spMfQODqnkxslmE3sMFsHCkEpV0GqNiboplpvjQCyWxKq8x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.967.0/index.min.mjs": "sha384-pQE4xS5LvdYzlB+x1spMfQODqnkxslmE3sMFsHCkEpV0GqNiboplpvjQCyWxKq8x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.967.0/LICENSE
```

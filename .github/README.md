...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QcseFaeJGB2wVjpc7OrpnwT4roRGvhGXka4QIlzwKOonwe393QMirqlZyC4mUxdu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.24.0/index.min.mjs": "sha384-QcseFaeJGB2wVjpc7OrpnwT4roRGvhGXka4QIlzwKOonwe393QMirqlZyC4mUxdu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.24.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GUcGxnwjSTbdA5MUAd6UcjWMW+XJSXeFUAdlOLYKgRHSk+sSJpl7+p3qypbW6cnD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.645.0/index.min.mjs": "sha384-GUcGxnwjSTbdA5MUAd6UcjWMW+XJSXeFUAdlOLYKgRHSk+sSJpl7+p3qypbW6cnD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.645.0/LICENSE
```

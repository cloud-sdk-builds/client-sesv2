...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wk8OIMfF6Xsezb5pbbA6hTxGNt5cv2iNCF6gfUdcAcIaTSWkBtv5OQpw+UyV5La1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.345.0/index.min.mjs": "sha384-Wk8OIMfF6Xsezb5pbbA6hTxGNt5cv2iNCF6gfUdcAcIaTSWkBtv5OQpw+UyV5La1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.345.0/LICENSE
```

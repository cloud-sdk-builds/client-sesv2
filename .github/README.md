...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VpmSMtmAaaP6Hjl2ftujSaOsUjhQHhSfzkSYDm+mvSjDeZb0bHrjAds+1/i1ycc5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.128.0/index.min.mjs": "sha384-VpmSMtmAaaP6Hjl2ftujSaOsUjhQHhSfzkSYDm+mvSjDeZb0bHrjAds+1/i1ycc5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.128.0/LICENSE
```

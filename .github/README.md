...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mceQAgXJau3PbL1DdUA6cf+/Z2yyv4V40IPo3gxEsrQMcJtBneeswjdO1QwqzGJj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.716.0/index.min.mjs": "sha384-mceQAgXJau3PbL1DdUA6cf+/Z2yyv4V40IPo3gxEsrQMcJtBneeswjdO1QwqzGJj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.716.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bNO7yGGC7jDr+CqlvTZ8tL37zKIfGURRBCa+sR2t8AHcXrmSt+K5tvkGqm5y8AiW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.295.0/index.min.mjs": "sha384-bNO7yGGC7jDr+CqlvTZ8tL37zKIfGURRBCa+sR2t8AHcXrmSt+K5tvkGqm5y8AiW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.295.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XaDRR6OjVm+HXmquZ1hHEIx/oGmIv3FvVOEjRGA2RKQPzCEE8pKxK30oqm0tl+wt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.985.0/index.min.mjs": "sha384-XaDRR6OjVm+HXmquZ1hHEIx/oGmIv3FvVOEjRGA2RKQPzCEE8pKxK30oqm0tl+wt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.985.0/LICENSE
```

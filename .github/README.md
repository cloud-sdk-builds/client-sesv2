...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UdM6O26qeiqyOokY2SAVorF/K1Sd2nhFQGClJ+YuawZ3zqs2gmEiwaxY2A0Z5pw2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.490.0/index.min.mjs": "sha384-UdM6O26qeiqyOokY2SAVorF/K1Sd2nhFQGClJ+YuawZ3zqs2gmEiwaxY2A0Z5pw2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.490.0/LICENSE
```

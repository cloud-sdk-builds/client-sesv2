...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qjeLr4TkXyOOA/1PYjINppw4lTzfL2Ks70ZugFeUDN+9XJ3ptMtCVs+V0esseWoI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.458.0/index.min.mjs": "sha384-qjeLr4TkXyOOA/1PYjINppw4lTzfL2Ks70ZugFeUDN+9XJ3ptMtCVs+V0esseWoI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.458.0/LICENSE
```

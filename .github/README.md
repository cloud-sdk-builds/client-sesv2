...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l2WOYWTGMylm5UGVoj/J3HiHtwJyL2O+d7FQyJAq+FW0jWBwR3FoZDrTr+wsq+BO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.812.0/index.min.mjs": "sha384-l2WOYWTGMylm5UGVoj/J3HiHtwJyL2O+d7FQyJAq+FW0jWBwR3FoZDrTr+wsq+BO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.812.0/LICENSE
```

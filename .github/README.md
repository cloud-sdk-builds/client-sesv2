...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L3j4lhcOCuf4wD/H9WQwz2Y4HZGiuOItX9s998ZgWWkDUPQR/jvQjxHIaW66HrX2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.264.0/index.min.mjs": "sha384-L3j4lhcOCuf4wD/H9WQwz2Y4HZGiuOItX9s998ZgWWkDUPQR/jvQjxHIaW66HrX2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.264.0/LICENSE
```

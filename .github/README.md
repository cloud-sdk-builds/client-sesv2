...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q1G6T6jFwABFIL2kDnvNxVDRFTMeK530Sy1xtr0my0akZkIDFIPYru2WK+0OlAfQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.972.0/index.min.mjs": "sha384-Q1G6T6jFwABFIL2kDnvNxVDRFTMeK530Sy1xtr0my0akZkIDFIPYru2WK+0OlAfQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.972.0/LICENSE
```

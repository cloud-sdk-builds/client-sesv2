...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r/GGNgIulBtKRqIHOSPTWN5kVNh6JHPmpeIjjN2xk1ZtuLwi1D4WZZHiMHYZfqYZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.667.0/index.min.mjs": "sha384-r/GGNgIulBtKRqIHOSPTWN5kVNh6JHPmpeIjjN2xk1ZtuLwi1D4WZZHiMHYZfqYZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.667.0/LICENSE
```

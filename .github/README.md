...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ku4NYpvepy+j+4lx9tcWW30heG7gk9X8i3uETj0aLSaIHE8BabanEoMIz4N5C45c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.131.0/index.min.mjs": "sha384-Ku4NYpvepy+j+4lx9tcWW30heG7gk9X8i3uETj0aLSaIHE8BabanEoMIz4N5C45c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.131.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zj4takWxetBCsqAFhf4+Eb/XymDl9FeI9iPKyGVHuRH7liHsgAiV0rWqEu0rX61d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.744.0/index.min.mjs": "sha384-Zj4takWxetBCsqAFhf4+Eb/XymDl9FeI9iPKyGVHuRH7liHsgAiV0rWqEu0rX61d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.744.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S1ioAc9cmC/2zDPrikXjxoA5da5gBjJWJI4oC+MVFXOFL6JkICyGKGmwrtFuZ4wI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.271.0/index.min.mjs": "sha384-S1ioAc9cmC/2zDPrikXjxoA5da5gBjJWJI4oC+MVFXOFL6JkICyGKGmwrtFuZ4wI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.271.0/LICENSE
```

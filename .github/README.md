...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6iaI6658gLospIqZWKEusUTua/av/xmUfhWzJifS3hSYxa2+kH/tRcpy0cRwynWA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.212.0/index.min.mjs": "sha384-6iaI6658gLospIqZWKEusUTua/av/xmUfhWzJifS3hSYxa2+kH/tRcpy0cRwynWA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.212.0/LICENSE
```

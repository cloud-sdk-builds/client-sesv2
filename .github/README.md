...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pM4jYABLcY/2mFFziRVJWIdLDMTsi4Jp751y+lXqICaixTHWXNAtoum+2QwPe3n3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.337.0/index.min.mjs": "sha384-pM4jYABLcY/2mFFziRVJWIdLDMTsi4Jp751y+lXqICaixTHWXNAtoum+2QwPe3n3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.337.0/LICENSE
```

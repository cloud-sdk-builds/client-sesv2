...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SSHAjIWUvyqd5+PmP4Gv7UI2e81mODaZ8NcrFl9xxBB04Pq+R8Yv3cjf3HCwZUdP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.474.0/index.min.mjs": "sha384-SSHAjIWUvyqd5+PmP4Gv7UI2e81mODaZ8NcrFl9xxBB04Pq+R8Yv3cjf3HCwZUdP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.474.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-reu/dxmsM/71CBenInTv0y2goTu7Vor22zcks6YCbWs4d9apm83cJfBP8GTCTkie
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.13.1/index.min.mjs": "sha384-reu/dxmsM/71CBenInTv0y2goTu7Vor22zcks6YCbWs4d9apm83cJfBP8GTCTkie"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.13.1/LICENSE
```

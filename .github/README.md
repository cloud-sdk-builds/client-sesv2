...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fnapGKawRRW1ojFYhRUhNQPkoguIx4DgRT1d2ik8LUnMK4T+GhaTRKHyKFlN2X+i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.0/index.min.mjs": "sha384-fnapGKawRRW1ojFYhRUhNQPkoguIx4DgRT1d2ik8LUnMK4T+GhaTRKHyKFlN2X+i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.47.0/LICENSE
```

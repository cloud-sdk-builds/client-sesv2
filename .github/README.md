...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lwAdxpmD5xxppw5dd70pChE8QZwBNYYGWjiwNwGUKUljdat6PfCCspHa81Xl5Tx2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.37.0/index.min.mjs": "sha384-lwAdxpmD5xxppw5dd70pChE8QZwBNYYGWjiwNwGUKUljdat6PfCCspHa81Xl5Tx2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.37.0/LICENSE
```

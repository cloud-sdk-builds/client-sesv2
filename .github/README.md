...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.403.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.403.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P05vdxuF3gXKU6oSquR4exd/OprBuV9ITpq6j4t3CC8P1JQeCrK0jD7+2ZVNFgE8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.403.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.403.0/index.min.mjs": "sha384-P05vdxuF3gXKU6oSquR4exd/OprBuV9ITpq6j4t3CC8P1JQeCrK0jD7+2ZVNFgE8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.403.0/LICENSE
```

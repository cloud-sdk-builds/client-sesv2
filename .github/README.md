...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QRTaupLRPIBRlvYY+K5QTeVIyzI5t48UJS4gNN/FjrPJse3DmdDXxHgYQ6QzXXND
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.288.0/index.min.mjs": "sha384-QRTaupLRPIBRlvYY+K5QTeVIyzI5t48UJS4gNN/FjrPJse3DmdDXxHgYQ6QzXXND"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.288.0/LICENSE
```

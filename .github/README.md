...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-34djRDcU/1+E9qeILtBll+hner4X4+7qJVQ8YOTv9zFeEZVmMeExe516LCq5fv4D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.259.0/index.min.mjs": "sha384-34djRDcU/1+E9qeILtBll+hner4X4+7qJVQ8YOTv9zFeEZVmMeExe516LCq5fv4D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.259.0/LICENSE
```

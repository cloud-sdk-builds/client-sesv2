...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4ulsAbPyJ2R5tLDD5+eXk2eqexwMcIMi5pDxI+2wIn6VuRMCW43cQXcgNDqX9sg0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.409.0/index.min.mjs": "sha384-4ulsAbPyJ2R5tLDD5+eXk2eqexwMcIMi5pDxI+2wIn6VuRMCW43cQXcgNDqX9sg0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.409.0/LICENSE
```

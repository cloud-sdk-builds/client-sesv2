...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NCSKVt7+RM9/1MAx6vDjlmKYUFD6JB9hyLAmYiEXindEodAgMklIQtgKv4oZevq8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.913.0/index.min.mjs": "sha384-NCSKVt7+RM9/1MAx6vDjlmKYUFD6JB9hyLAmYiEXindEodAgMklIQtgKv4oZevq8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.913.0/LICENSE
```

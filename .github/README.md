...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+mkpo2LVzvH6d5iElh2s4cQ9320scjtcYpTY6maPY60WHZGFefratgic5+Vp1eHk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.772.0/index.min.mjs": "sha384-+mkpo2LVzvH6d5iElh2s4cQ9320scjtcYpTY6maPY60WHZGFefratgic5+Vp1eHk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.772.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ob/z3uN6AqfQA6M2KixfQpITvEbP8fczIOv9Egtp4pYtJpkSrcw9zxdF+8tYghsg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.476.0/index.min.mjs": "sha384-Ob/z3uN6AqfQA6M2KixfQpITvEbP8fczIOv9Egtp4pYtJpkSrcw9zxdF+8tYghsg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.476.0/LICENSE
```

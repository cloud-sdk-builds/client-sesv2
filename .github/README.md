...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pISrahfsN8rAYvmoc1tRhzXvgTIEmXS0IvnPdQBh0EC5PPV/i71NUnSfU2zGORQr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.95.0/index.min.mjs": "sha384-pISrahfsN8rAYvmoc1tRhzXvgTIEmXS0IvnPdQBh0EC5PPV/i71NUnSfU2zGORQr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.95.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tUukMTznonEGNhorT5Y7p6LYWiw5DA86iUkVeiKlK/Hy4Z+ltIYBs5IGjwDoUOlU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.297.0/index.min.mjs": "sha384-tUukMTznonEGNhorT5Y7p6LYWiw5DA86iUkVeiKlK/Hy4Z+ltIYBs5IGjwDoUOlU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.297.0/LICENSE
```

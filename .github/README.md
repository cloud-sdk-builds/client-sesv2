...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GF82pu+oYIPCaMrL5vUr5B5uWT7vpDh88RQobUrW5yW9ZNXCnutGEFK8kxKq3QdO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.38.0/index.min.mjs": "sha384-GF82pu+oYIPCaMrL5vUr5B5uWT7vpDh88RQobUrW5yW9ZNXCnutGEFK8kxKq3QdO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.38.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o8MreMscQQEx14ZY8fJp2cnSbER3dNxcorTPPj8s4d6yAorNbMqTeQXJ659m15ra
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.34.0/index.min.mjs": "sha384-o8MreMscQQEx14ZY8fJp2cnSbER3dNxcorTPPj8s4d6yAorNbMqTeQXJ659m15ra"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.34.0/LICENSE
```

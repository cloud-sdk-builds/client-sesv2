...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.633.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.633.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hb/rFw2r0xv4SV6wsxjMTtw9njeasjnU5Y6hRW+/UyxGt+bdKunXYMNuVm5BDbvz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.633.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.633.0/index.min.mjs": "sha384-Hb/rFw2r0xv4SV6wsxjMTtw9njeasjnU5Y6hRW+/UyxGt+bdKunXYMNuVm5BDbvz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.633.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-GQGZS67i5NrteC3+rWo/D/KqD7BJD0NKMy7eMTx4+el+n5i2qP078+bLgEBywuht
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.118.1/index.min.mjs": "sha384-GQGZS67i5NrteC3+rWo/D/KqD7BJD0NKMy7eMTx4+el+n5i2qP078+bLgEBywuht"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.118.1/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M++cJSLFgin/TdK+0GMtY8GE9OyhhuWMpn5T5O2nMKZIZl4IxN7uxAn0hLhOCuMQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.568.0/index.min.mjs": "sha384-M++cJSLFgin/TdK+0GMtY8GE9OyhhuWMpn5T5O2nMKZIZl4IxN7uxAn0hLhOCuMQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.568.0/LICENSE
```

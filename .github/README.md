...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hucAVWBd6kKuy2nh/WUBD8CAgyvl9mHU2P/L6RMbFMUpWV1Z4Gf0tPyPwhUwlBep
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.692.0/index.min.mjs": "sha384-hucAVWBd6kKuy2nh/WUBD8CAgyvl9mHU2P/L6RMbFMUpWV1Z4Gf0tPyPwhUwlBep"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.692.0/LICENSE
```

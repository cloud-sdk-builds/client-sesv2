...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/07EHWI+sUjmNW9J0MUd6Cn04ANgdy/zCOWihXTzE9NSi+pzz3w/NUao+Xi7fvU8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.577.0/index.min.mjs": "sha384-/07EHWI+sUjmNW9J0MUd6Cn04ANgdy/zCOWihXTzE9NSi+pzz3w/NUao+Xi7fvU8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.577.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SRbYhXLR3+Ue5N5ol2SS+5C8q9hH9QrOdzN0Uo+MlrKFFdP1izWmBchmcWdNHio+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.26.0/index.min.mjs": "sha384-SRbYhXLR3+Ue5N5ol2SS+5C8q9hH9QrOdzN0Uo+MlrKFFdP1izWmBchmcWdNHio+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.26.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gFgMB7Mh5fevEhfJwCS9kC9Rh2JSJS+pmDuhCTDjgSX0USunLA3+hsd7NwNzJujh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.576.0/index.min.mjs": "sha384-gFgMB7Mh5fevEhfJwCS9kC9Rh2JSJS+pmDuhCTDjgSX0USunLA3+hsd7NwNzJujh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.576.0/LICENSE
```

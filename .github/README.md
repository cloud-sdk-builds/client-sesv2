...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l3xAkPtm7wXap23NF64vNbws/wogF0akxMMtunLIzSXUkIx8ZwVOyXdMxsj0Urym
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.235.0/index.min.mjs": "sha384-l3xAkPtm7wXap23NF64vNbws/wogF0akxMMtunLIzSXUkIx8ZwVOyXdMxsj0Urym"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.235.0/LICENSE
```

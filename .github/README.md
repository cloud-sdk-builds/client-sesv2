...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2yAyd7qCVxgHKhuVSeZjgWaym4z+1pxGVkN5YlT8DdnGEcDwWUdzWO143ovMPFic
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.741.0/index.min.mjs": "sha384-2yAyd7qCVxgHKhuVSeZjgWaym4z+1pxGVkN5YlT8DdnGEcDwWUdzWO143ovMPFic"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.741.0/LICENSE
```

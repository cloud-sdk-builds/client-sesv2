...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V4AOwb/8d8XKuCRISi87WEN0ECdU2HScs0v2Dv7g+YbJURRBs+6IQTmdBn0rPPgk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.873.0/index.min.mjs": "sha384-V4AOwb/8d8XKuCRISi87WEN0ECdU2HScs0v2Dv7g+YbJURRBs+6IQTmdBn0rPPgk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.873.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nLLMtOTj+Uk2BQ9Gsr+4CqjoGORhWaSNpqASROmoJYbChdJv/nEiJ93X4nNrgjmp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.600.0/index.min.mjs": "sha384-nLLMtOTj+Uk2BQ9Gsr+4CqjoGORhWaSNpqASROmoJYbChdJv/nEiJ93X4nNrgjmp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.600.0/LICENSE
```

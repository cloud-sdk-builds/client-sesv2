...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f8AIebMb1R6VOiO88xJLuF7qvjEdnumecvuysfeeVFLLJh2ku6tH9wXXbL1XiHC+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.202.0/index.min.mjs": "sha384-f8AIebMb1R6VOiO88xJLuF7qvjEdnumecvuysfeeVFLLJh2ku6tH9wXXbL1XiHC+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.202.0/LICENSE
```

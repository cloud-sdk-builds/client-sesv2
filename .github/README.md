...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l+eMkK6qyPzx9RJqgXAg2iMiLd6mhelK+hoGWCj2goP4tzlMWpqhT9SrYpKGmVqb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.787.0/index.min.mjs": "sha384-l+eMkK6qyPzx9RJqgXAg2iMiLd6mhelK+hoGWCj2goP4tzlMWpqhT9SrYpKGmVqb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.787.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UrIwbFtedZJfbXvXf2FyJIIQ0wtkFwQKQ0kXQmMXeZGL4m4yANUK8Vwcwzkq9C6r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.41.0/index.min.mjs": "sha384-UrIwbFtedZJfbXvXf2FyJIIQ0wtkFwQKQ0kXQmMXeZGL4m4yANUK8Vwcwzkq9C6r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.41.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A0OWO+hYZAL9VrjhZTgzDorCLgLmc35bZ5NPGXpUc57furqvYpeI6WOZOK0qKAih
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.385.0/index.min.mjs": "sha384-A0OWO+hYZAL9VrjhZTgzDorCLgLmc35bZ5NPGXpUc57furqvYpeI6WOZOK0qKAih"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.385.0/LICENSE
```

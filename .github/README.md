...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KWDgcCUfAXr6AeBpdj9KM1s+oiJ+dKyqB6RfyfGeNM63OwJjF8+LvOE/qcCA8Gte
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.222.0/index.min.mjs": "sha384-KWDgcCUfAXr6AeBpdj9KM1s+oiJ+dKyqB6RfyfGeNM63OwJjF8+LvOE/qcCA8Gte"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.222.0/LICENSE
```

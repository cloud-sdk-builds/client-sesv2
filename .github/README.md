...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xL+bN0qlyGs/7wjxRJBn4HBHotd4sWs0dX7p0Dz5xKbF7qfmRqBaZiY+ZLFo1cIr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.816.0/index.min.mjs": "sha384-xL+bN0qlyGs/7wjxRJBn4HBHotd4sWs0dX7p0Dz5xKbF7qfmRqBaZiY+ZLFo1cIr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.816.0/LICENSE
```

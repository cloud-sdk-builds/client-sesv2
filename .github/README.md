...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9a/w9wYdr5v+4dfGgW9/Rmqhw9UtmHfYzTVkdW0OU4e7xsL9P75Pk5xGSUUTkZgS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.999.0/index.min.mjs": "sha384-9a/w9wYdr5v+4dfGgW9/Rmqhw9UtmHfYzTVkdW0OU4e7xsL9P75Pk5xGSUUTkZgS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.999.0/LICENSE
```

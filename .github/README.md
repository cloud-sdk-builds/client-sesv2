...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gYVI2aDA5NVYkSDzkJnd7Y+Xbt4sZQfvZd0TxEN0lA54stceKFJbp7IZ2RmgLfEC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.957.0/index.min.mjs": "sha384-gYVI2aDA5NVYkSDzkJnd7Y+Xbt4sZQfvZd0TxEN0lA54stceKFJbp7IZ2RmgLfEC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.957.0/LICENSE
```

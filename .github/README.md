...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.710.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.710.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ld5uOhBwwpPxrSzcGGQBbi4tIOYKP79wjQh9bWIkGcS9jeLQH/mFROHxp0NMHFC8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.710.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.710.0/index.min.mjs": "sha384-ld5uOhBwwpPxrSzcGGQBbi4tIOYKP79wjQh9bWIkGcS9jeLQH/mFROHxp0NMHFC8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.710.0/LICENSE
```

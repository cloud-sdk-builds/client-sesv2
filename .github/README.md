...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-abnJHPD0fSaPpCsZbwsqiutczidToB81KZRnIfKMSa4wTq1rwI61ZNxIMp+W9m5O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.693.0/index.min.mjs": "sha384-abnJHPD0fSaPpCsZbwsqiutczidToB81KZRnIfKMSa4wTq1rwI61ZNxIMp+W9m5O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.693.0/LICENSE
```

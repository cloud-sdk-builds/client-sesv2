...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Vs2TpIiakjdUaAmNMbO1rYoYN6dDoTsxVEwWuNxXib3KFFDTHrR02rwCag+lcJmc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.315.0/index.min.mjs": "sha384-Vs2TpIiakjdUaAmNMbO1rYoYN6dDoTsxVEwWuNxXib3KFFDTHrR02rwCag+lcJmc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.315.0/LICENSE
```

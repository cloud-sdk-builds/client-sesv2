...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z4JHB3j2RBOR357s/CDcgNuLRFbhj0bY6NYt2P85mtuN+zGlLX5jF6z/2Eu8CZKC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.325.0/index.min.mjs": "sha384-Z4JHB3j2RBOR357s/CDcgNuLRFbhj0bY6NYt2P85mtuN+zGlLX5jF6z/2Eu8CZKC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.325.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-oyBCYpnWPDbiLdjrOitigwxtFozaPpqqgandoG1ueTd+CDBJVQDqtaOUZ9rn1iMz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.503.1/index.min.mjs": "sha384-oyBCYpnWPDbiLdjrOitigwxtFozaPpqqgandoG1ueTd+CDBJVQDqtaOUZ9rn1iMz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.503.1/LICENSE
```

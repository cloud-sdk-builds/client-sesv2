...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0uWlO0Suese9QesuYSo9AILohnAdtov7m5mD4HIK9Wfu+VcQXbBQGOiNQ+ODS8q+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.418.0/index.min.mjs": "sha384-0uWlO0Suese9QesuYSo9AILohnAdtov7m5mD4HIK9Wfu+VcQXbBQGOiNQ+ODS8q+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.418.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9XppIJD5K2z5JdvuUJ+FmMpIUYLo3sDISZ3X7fqN5J30Z/1QmYlSnNNBlh0VWKS4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.350.0/index.min.mjs": "sha384-9XppIJD5K2z5JdvuUJ+FmMpIUYLo3sDISZ3X7fqN5J30Z/1QmYlSnNNBlh0VWKS4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.350.0/LICENSE
```

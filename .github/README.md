...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eTimgLrpP/JuDVnnRYkYmxm/4toWCxmnYLP3yPWqz0e93XYj2bK7LCYgZZ2A61GJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.952.0/index.min.mjs": "sha384-eTimgLrpP/JuDVnnRYkYmxm/4toWCxmnYLP3yPWqz0e93XYj2bK7LCYgZZ2A61GJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.952.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AgMAvCUEFDXCRdfiFSsZQgNISyPe2MyHtX3F6H8mPxXsWV+IicEdIVW+SDd1xq1K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.181.0/index.min.mjs": "sha384-AgMAvCUEFDXCRdfiFSsZQgNISyPe2MyHtX3F6H8mPxXsWV+IicEdIVW+SDd1xq1K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.181.0/LICENSE
```

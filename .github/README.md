...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-7ByyHkBn/J2bZCoWCFxTFYpgFrSc/1S+M6RXy3qF0OT9KDdf818wpstT/RvFBa3m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.6.1/index.min.mjs": "sha384-7ByyHkBn/J2bZCoWCFxTFYpgFrSc/1S+M6RXy3qF0OT9KDdf818wpstT/RvFBa3m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.6.1/LICENSE
```

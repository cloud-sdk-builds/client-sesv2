...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Fkr8Jvp29fIKN1QctobjbFmIDORxb58jEiLOU8B1LBMcntH9+DGahvzp47SgntRa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.398.0/index.min.mjs": "sha384-Fkr8Jvp29fIKN1QctobjbFmIDORxb58jEiLOU8B1LBMcntH9+DGahvzp47SgntRa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.398.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DLwWznH018ELPMFFLNTIKB7oqJF/eYgSG5ZFoSaWEpc75BNKvR4+vlfpEvq9Op9b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.58.0/index.min.mjs": "sha384-DLwWznH018ELPMFFLNTIKB7oqJF/eYgSG5ZFoSaWEpc75BNKvR4+vlfpEvq9Op9b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.58.0/LICENSE
```

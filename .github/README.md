...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n7onLzY+T+0KpJQnYlUyON1SUY++OqyNj5k3HzAn/T5/zCGoL9tcn4LlleX3fNeb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.185.0/index.min.mjs": "sha384-n7onLzY+T+0KpJQnYlUyON1SUY++OqyNj5k3HzAn/T5/zCGoL9tcn4LlleX3fNeb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.185.0/LICENSE
```

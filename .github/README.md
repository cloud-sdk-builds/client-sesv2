...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-spQZsmfpT1TxQCU9Ylne8jBo+HaIucmTIB+weKpQ4j/uEyo9Ygd2Ojks5xsH9zEV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.218.0/index.min.mjs": "sha384-spQZsmfpT1TxQCU9Ylne8jBo+HaIucmTIB+weKpQ4j/uEyo9Ygd2Ojks5xsH9zEV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.218.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fgex0xe6ypnhXvegPbpACHhw7+254MBVoYJHhVA5LoTLyqj8HYkWKqJwl4ZSkMXo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.17.0/index.min.mjs": "sha384-fgex0xe6ypnhXvegPbpACHhw7+254MBVoYJHhVA5LoTLyqj8HYkWKqJwl4ZSkMXo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.17.0/LICENSE
```

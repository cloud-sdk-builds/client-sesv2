...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I6zarSpJ3LsVAc4dOv4+cy5NH+HU6834CdfiU+9YcHJfcFpEpnccWiKaOlUaBIJj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.916.0/index.min.mjs": "sha384-I6zarSpJ3LsVAc4dOv4+cy5NH+HU6834CdfiU+9YcHJfcFpEpnccWiKaOlUaBIJj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.916.0/LICENSE
```

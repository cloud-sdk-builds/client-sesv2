...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.527.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.527.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JNxLnls7VVgCFo4FGVZnEsVaL13dzHXqJmRJq3nfB3NS6VlrrgEJo1pVOkfrIAFZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.527.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.527.0/index.min.mjs": "sha384-JNxLnls7VVgCFo4FGVZnEsVaL13dzHXqJmRJq3nfB3NS6VlrrgEJo1pVOkfrIAFZ"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.527.0`)
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.527.0/LICENSE
```

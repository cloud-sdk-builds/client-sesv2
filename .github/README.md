...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gP6vbONuEiFXwbAoUFa1ka47LFd8+JbWkYTV6ogDy/KCpzz4mUxN7GZYVRoHHjDY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.272.0/index.min.mjs": "sha384-gP6vbONuEiFXwbAoUFa1ka47LFd8+JbWkYTV6ogDy/KCpzz4mUxN7GZYVRoHHjDY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.272.0/LICENSE
```

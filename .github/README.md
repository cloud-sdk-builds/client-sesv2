...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oDR5Vvy7bkRHeF72VIHgxsBAPZ3EsD7bDDoXzyQ5FkoXnSHqJDtDbM5yWtc9kGEk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.552.0/index.min.mjs": "sha384-oDR5Vvy7bkRHeF72VIHgxsBAPZ3EsD7bDDoXzyQ5FkoXnSHqJDtDbM5yWtc9kGEk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.552.0/LICENSE
```

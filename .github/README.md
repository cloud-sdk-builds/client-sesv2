...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X19THsl4a8VvNuOyytudyk+WKG5Aiiqaz5PA0XZpERCya/0lzecPB0RNQbMYj9Cx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.583.0/index.min.mjs": "sha384-X19THsl4a8VvNuOyytudyk+WKG5Aiiqaz5PA0XZpERCya/0lzecPB0RNQbMYj9Cx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.583.0/LICENSE
```

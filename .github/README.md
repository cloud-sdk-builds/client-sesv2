...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.13.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.13.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cr/VbJEn4HGlCXVQW52yDnZTk//AoVVMEqf6qaTb32/HNxn7/MEtw/NviKGFLhNZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.13.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.13.0/index.min.mjs": "sha384-Cr/VbJEn4HGlCXVQW52yDnZTk//AoVVMEqf6qaTb32/HNxn7/MEtw/NviKGFLhNZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.13.0/LICENSE
```

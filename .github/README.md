...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iXZX7sxfSgdaj8bR4vCeHXqFSmjBi5Ob4rzILCwx1X2FPafp/iPAfC4+/t0EQqVF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.261.0/index.min.mjs": "sha384-iXZX7sxfSgdaj8bR4vCeHXqFSmjBi5Ob4rzILCwx1X2FPafp/iPAfC4+/t0EQqVF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.261.0/LICENSE
```

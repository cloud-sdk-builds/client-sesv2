...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+65rEQjmBjxJoR3nulU6myLeXt43KDbNSwUjxN5NE5AgrVlgkjd+oVLwvmlyIAgW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.723.0/index.min.mjs": "sha384-+65rEQjmBjxJoR3nulU6myLeXt43KDbNSwUjxN5NE5AgrVlgkjd+oVLwvmlyIAgW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.723.0/LICENSE
```

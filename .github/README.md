...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.199.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.199.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FylHr4VRvi+tp02ARGUG0aURBm9aruqTDCi0zHitKgFeby9y8j/5O+fhKDKlAkwr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.199.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.199.0/index.min.mjs": "sha384-FylHr4VRvi+tp02ARGUG0aURBm9aruqTDCi0zHitKgFeby9y8j/5O+fhKDKlAkwr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.199.0/LICENSE
```

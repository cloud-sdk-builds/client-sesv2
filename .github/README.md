...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FxG9/CjIvUSur8Eq++L5ZGrCzVtzQ/ASTYlZ5ON24Rk0dTVLFTpC/vJbxmWnyIQy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.121.0/index.min.mjs": "sha384-FxG9/CjIvUSur8Eq++L5ZGrCzVtzQ/ASTYlZ5ON24Rk0dTVLFTpC/vJbxmWnyIQy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.121.0/LICENSE
```

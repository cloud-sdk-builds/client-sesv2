...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w69/1zq1leclZXDigxy9ughk50iZURdUxP02jwAaySxo8S4AJlMEiEXjG4UCG7O6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.926.0/index.min.mjs": "sha384-w69/1zq1leclZXDigxy9ughk50iZURdUxP02jwAaySxo8S4AJlMEiEXjG4UCG7O6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.926.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4uw3tCGVMWUG35zX4b7Oow8PojRtMiPG+MpEr+dvxBrkL+5+5Jw05Cw3y77GiyQq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.15.0/index.min.mjs": "sha384-4uw3tCGVMWUG35zX4b7Oow8PojRtMiPG+MpEr+dvxBrkL+5+5Jw05Cw3y77GiyQq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.15.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-an6BABnmMB3vfG8XOQHpygXgLSW8NdmKSawo3rnk5ghbbAixI7ikAuQNxeuZEX58
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.431.0/index.min.mjs": "sha384-an6BABnmMB3vfG8XOQHpygXgLSW8NdmKSawo3rnk5ghbbAixI7ikAuQNxeuZEX58"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.431.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TCcbMh4q4YJ1nCvxey9dcaQCHojXMeronS9tD+JcmV6RpbowCU9tpvskCwBeEiLF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.678.0/index.min.mjs": "sha384-TCcbMh4q4YJ1nCvxey9dcaQCHojXMeronS9tD+JcmV6RpbowCU9tpvskCwBeEiLF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.678.0/LICENSE
```

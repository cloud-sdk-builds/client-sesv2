...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cAjq0+V04oH14YaLiqSAFrCUbZewRUnEPBG4PuW01to2Hr7EMl26+5+clgd3wKaO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.799.0/index.min.mjs": "sha384-cAjq0+V04oH14YaLiqSAFrCUbZewRUnEPBG4PuW01to2Hr7EMl26+5+clgd3wKaO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.799.0/LICENSE
```

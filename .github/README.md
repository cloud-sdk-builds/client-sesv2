...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vUddT7g9PQmO4nPiktXsEr+B333D+uAyjBByajVmCBRVYDsYjDRxRHadDaQ+BV8E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.303.0/index.min.mjs": "sha384-vUddT7g9PQmO4nPiktXsEr+B333D+uAyjBByajVmCBRVYDsYjDRxRHadDaQ+BV8E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.303.0/LICENSE
```

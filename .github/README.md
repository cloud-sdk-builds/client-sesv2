...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fcc7WJHVNrCtiUOcSidJWisC4MnP7aMtoNlK8wVSt2be5/wRto5IeQu6RCPcuKwD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.226.0/index.min.mjs": "sha384-fcc7WJHVNrCtiUOcSidJWisC4MnP7aMtoNlK8wVSt2be5/wRto5IeQu6RCPcuKwD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.226.0/LICENSE
```

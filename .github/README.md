...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZuzETPVRT+wd2UH0IObPHYNtdhluSPir0W6zVBc1A8Pn/JwRGBCHbKL6POS3B1qe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.620.1/index.min.mjs": "sha384-ZuzETPVRT+wd2UH0IObPHYNtdhluSPir0W6zVBc1A8Pn/JwRGBCHbKL6POS3B1qe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.620.1/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2LfCPVmC7mMn1DkmcptlmdKMbKbfqu7s6pK2R2a24Rb/p/J5KpujM4MOJJAKZkot
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.165.0/index.min.mjs": "sha384-2LfCPVmC7mMn1DkmcptlmdKMbKbfqu7s6pK2R2a24Rb/p/J5KpujM4MOJJAKZkot"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.165.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-BYNaMKaFyabNmik6JvIkmOK/yzhJIzJNkfw5PfV4yozwCypiBJr6AuULRJhWY6Sg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.2/index.min.mjs": "sha384-BYNaMKaFyabNmik6JvIkmOK/yzhJIzJNkfw5PfV4yozwCypiBJr6AuULRJhWY6Sg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.47.2/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H7Vn1Of1iFLJNMGct5U2tHFbUGs+BWSyB7sC2uO8ugcv07ACH3px/yY/IiwlhKFP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.335.0/index.min.mjs": "sha384-H7Vn1Of1iFLJNMGct5U2tHFbUGs+BWSyB7sC2uO8ugcv07ACH3px/yY/IiwlhKFP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.335.0/LICENSE
```

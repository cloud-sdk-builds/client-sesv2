...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XpDOTXMmh+7zrIlB/5G6lf+yNYrHUq2n8iAZBFyxsuhnHV4sU99oR2lv+K7CzHmY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.499.0/index.min.mjs": "sha384-XpDOTXMmh+7zrIlB/5G6lf+yNYrHUq2n8iAZBFyxsuhnHV4sU99oR2lv+K7CzHmY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.499.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N2mTwvSZw8HTTk8S8YCEXEWklxnlbTIGemso0VQwsSTNfd+gWfJ6Rxgyt6mTd5Br
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.388.0/index.min.mjs": "sha384-N2mTwvSZw8HTTk8S8YCEXEWklxnlbTIGemso0VQwsSTNfd+gWfJ6Rxgyt6mTd5Br"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.388.0/LICENSE
```

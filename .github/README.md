...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YHNeKxuAC1wAyxTGFkXdyo43s0tZ1hC3z/CVDp2nWkPnL2qrN+3kQJ00imCl0pW1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.82.0/index.min.mjs": "sha384-YHNeKxuAC1wAyxTGFkXdyo43s0tZ1hC3z/CVDp2nWkPnL2qrN+3kQJ00imCl0pW1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.82.0/LICENSE
```

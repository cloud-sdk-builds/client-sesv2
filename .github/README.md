...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.1009.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.1009.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p43WwbikOxkoud35/C6v6DLyMTv+e2UNlfgveruBsd4dBtljAFGUvi9s4zgUBA4a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.1009.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.1009.0/index.min.mjs": "sha384-p43WwbikOxkoud35/C6v6DLyMTv+e2UNlfgveruBsd4dBtljAFGUvi9s4zgUBA4a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.1009.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AoQ4qjkjwYGOjIsiMD4vgASzcnsB6SV+sB6lC9D1wunIx3K1chVYP4fE/Xu6afcl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.862.0/index.min.mjs": "sha384-AoQ4qjkjwYGOjIsiMD4vgASzcnsB6SV+sB6lC9D1wunIx3K1chVYP4fE/Xu6afcl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.862.0/LICENSE
```

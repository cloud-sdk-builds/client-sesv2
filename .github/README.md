...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4/6MvefSMfPkK9QUcmMB659G+nEUY5XqLFXzvZ7lT1z39S8AFoPK7eJLYbtWwzvK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.55.0/index.min.mjs": "sha384-4/6MvefSMfPkK9QUcmMB659G+nEUY5XqLFXzvZ7lT1z39S8AFoPK7eJLYbtWwzvK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.55.0/LICENSE
```

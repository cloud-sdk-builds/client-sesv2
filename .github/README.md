...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2BZUuMnaTv3e9OrErtkSx2CKbT6zJmpkrCyIr2ChRFxcmHRdUpuGV07+0sKLuFfE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.846.0/index.min.mjs": "sha384-2BZUuMnaTv3e9OrErtkSx2CKbT6zJmpkrCyIr2ChRFxcmHRdUpuGV07+0sKLuFfE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.846.0/LICENSE
```

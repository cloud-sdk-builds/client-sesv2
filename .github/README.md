...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FoPGepSX4+PDhbU1rztBg/bcbBpWKrqoHjT1KANUZFEiwV7nsbCIn3UguSBgj6M9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.749.0/index.min.mjs": "sha384-FoPGepSX4+PDhbU1rztBg/bcbBpWKrqoHjT1KANUZFEiwV7nsbCIn3UguSBgj6M9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.749.0/LICENSE
```

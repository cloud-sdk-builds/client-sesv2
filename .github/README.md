...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iwdHWs47+GN9Ob0sicNLqovNdTeKHlteH5bsSqKj9z3peM0WcIXr3YD10iYNY+ru
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.666.0/index.min.mjs": "sha384-iwdHWs47+GN9Ob0sicNLqovNdTeKHlteH5bsSqKj9z3peM0WcIXr3YD10iYNY+ru"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.666.0/LICENSE
```

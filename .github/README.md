...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bexeiPtaxwmPnmv02j8cHns5XQ4VxaKGHAuLYbNY7ssl4FUUogJHC/gV/+Qn1egk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.51.0/index.min.mjs": "sha384-bexeiPtaxwmPnmv02j8cHns5XQ4VxaKGHAuLYbNY7ssl4FUUogJHC/gV/+Qn1egk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.51.0/LICENSE
```

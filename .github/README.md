...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bpOwmErTGpsXJayxnCwATydp4EfGpgQXNqV1nvfjp/hQX4PQ3ZlQe80ZVxiVf4m4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.310.0/index.min.mjs": "sha384-bpOwmErTGpsXJayxnCwATydp4EfGpgQXNqV1nvfjp/hQX4PQ3ZlQe80ZVxiVf4m4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.310.0/LICENSE
```

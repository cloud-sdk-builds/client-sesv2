...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fBDGtdzDmJjKp4E2eCv4iSzdEm/6qGR9bxDMUQaYwyL6WnPqk1KJ4EvvZQjmiWNM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.572.0/index.min.mjs": "sha384-fBDGtdzDmJjKp4E2eCv4iSzdEm/6qGR9bxDMUQaYwyL6WnPqk1KJ4EvvZQjmiWNM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.572.0/LICENSE
```

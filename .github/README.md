...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bi+/JGVwEc4EbIbF3F7zrOVe6OeOmaPWAuUrIeT2dWbKCEhMjvSDe3vI7qrVwjRc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.163.0/index.min.mjs": "sha384-bi+/JGVwEc4EbIbF3F7zrOVe6OeOmaPWAuUrIeT2dWbKCEhMjvSDe3vI7qrVwjRc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.163.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nZ40+qXUDMcijva7jI3ewCArCEc9TppVUNiIkACJtmiUcQ7WgxspsA0Koe/ohS7G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.988.0/index.min.mjs": "sha384-nZ40+qXUDMcijva7jI3ewCArCEc9TppVUNiIkACJtmiUcQ7WgxspsA0Koe/ohS7G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.988.0/LICENSE
```

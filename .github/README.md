...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LzsuHQ3DFfLVk8sY7oQ+fLb/hXjsQgA0aGabgl1++7hNNUJaZkHqkdfGLm/9I4mx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.179.0/index.min.mjs": "sha384-LzsuHQ3DFfLVk8sY7oQ+fLb/hXjsQgA0aGabgl1++7hNNUJaZkHqkdfGLm/9I4mx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.179.0/LICENSE
```

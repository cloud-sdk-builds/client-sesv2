...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cHy7uWQ4PSOm7hZ17eJAoPMCWp1KU+rNv8XzWiIvbnUPqvQjkm3VM7eBHoRqKNDv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.984.0/index.min.mjs": "sha384-cHy7uWQ4PSOm7hZ17eJAoPMCWp1KU+rNv8XzWiIvbnUPqvQjkm3VM7eBHoRqKNDv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.984.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-czVQGDiqzHQ8eJBMzr8JFR4tvaQaMV+GennVsML/0oLkBJb0n4KAM3eKAEVgsG/N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.993.0/index.min.mjs": "sha384-czVQGDiqzHQ8eJBMzr8JFR4tvaQaMV+GennVsML/0oLkBJb0n4KAM3eKAEVgsG/N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.993.0/LICENSE
```

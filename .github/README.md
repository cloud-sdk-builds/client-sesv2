...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zTK9VYr04F8H4lCEpNrZCov8uw/v5mGBEQpk8uY/ePGBJXrY+Z7Jm/J6iZyrW8Y5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.201.0/index.min.mjs": "sha384-zTK9VYr04F8H4lCEpNrZCov8uw/v5mGBEQpk8uY/ePGBJXrY+Z7Jm/J6iZyrW8Y5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.201.0/LICENSE
```

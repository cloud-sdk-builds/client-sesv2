...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.660.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.660.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-huXE9xprsWKMkf2s4uhif6l8SgCbqy/pkXBp5tj4cTlmzqs7DH2skYRlFg11Icd4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.660.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.660.0/index.min.mjs": "sha384-huXE9xprsWKMkf2s4uhif6l8SgCbqy/pkXBp5tj4cTlmzqs7DH2skYRlFg11Icd4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.660.0/LICENSE
```

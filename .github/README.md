...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d343nm6V0ChUNHEzxpHsR1yh+8bfyJhBgg/20fsmjjmAOMRhedOz9cPSocFofEeC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.872.0/index.min.mjs": "sha384-d343nm6V0ChUNHEzxpHsR1yh+8bfyJhBgg/20fsmjjmAOMRhedOz9cPSocFofEeC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.872.0/LICENSE
```

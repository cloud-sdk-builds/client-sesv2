...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IQ6A7LnyzoiqHwEZ8MUAq/FGoHBly9LDBQhrltvTPxBNL2eNQB4CVO3cVO0vnFfI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.301.0/index.min.mjs": "sha384-IQ6A7LnyzoiqHwEZ8MUAq/FGoHBly9LDBQhrltvTPxBNL2eNQB4CVO3cVO0vnFfI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.301.0/LICENSE
```

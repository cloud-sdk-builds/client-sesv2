...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zPO1jOMQAfM8bXQK2vmquiQmAtoKfNiBC88N0GdOiQG7ba1ajPRVmA5s+xngV9h6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.19.0/index.min.mjs": "sha384-zPO1jOMQAfM8bXQK2vmquiQmAtoKfNiBC88N0GdOiQG7ba1ajPRVmA5s+xngV9h6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.19.0/LICENSE
```

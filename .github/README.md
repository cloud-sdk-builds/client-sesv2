...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bYyDwqlXLp3TU6/XZErUO/P7XVjyefWvMebVFKJRF0zsyM8KUM0VIj6+WltktPJB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.567.0/index.min.mjs": "sha384-bYyDwqlXLp3TU6/XZErUO/P7XVjyefWvMebVFKJRF0zsyM8KUM0VIj6+WltktPJB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.567.0/LICENSE
```

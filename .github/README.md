...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LKUlBKtdMdY/U04yU8NuBzdFe0C+B7hSi8l8ACOxr9xFWT5TYMz+6pvh+HhBoGeB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.428.0/index.min.mjs": "sha384-LKUlBKtdMdY/U04yU8NuBzdFe0C+B7hSi8l8ACOxr9xFWT5TYMz+6pvh+HhBoGeB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.428.0/LICENSE
```

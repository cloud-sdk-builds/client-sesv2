...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2SdGDBjLphJH5MgIVmPguNSs3LhI09bPvJT8/uTO6+vNnM+8inhh05H8jHrIvvAQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.56.0/index.min.mjs": "sha384-2SdGDBjLphJH5MgIVmPguNSs3LhI09bPvJT8/uTO6+vNnM+8inhh05H8jHrIvvAQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.56.0/LICENSE
```

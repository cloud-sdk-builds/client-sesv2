...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w6DrhRjYlKHsqSs2pxk+zAWbB8KUeuEAnXPxGsN+iJL0JXPZ8mCoZWOD/UyOx5lV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.405.0/index.min.mjs": "sha384-w6DrhRjYlKHsqSs2pxk+zAWbB8KUeuEAnXPxGsN+iJL0JXPZ8mCoZWOD/UyOx5lV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.405.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Twi0Wl6nvVlXqoyHbxaYyRlHt2eNBHhqVJ6MT6DctPuE2/ZAYK/3sl1ifxsTLa8O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.254.0/index.min.mjs": "sha384-Twi0Wl6nvVlXqoyHbxaYyRlHt2eNBHhqVJ6MT6DctPuE2/ZAYK/3sl1ifxsTLa8O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.254.0/LICENSE
```

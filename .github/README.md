...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tKdNQB7+RwHj97vj66SuM/R2rqX9L6GSnJmwrahXTVqDXHvEFurd+/XpgsRL5UnX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.48.0/index.min.mjs": "sha384-tKdNQB7+RwHj97vj66SuM/R2rqX9L6GSnJmwrahXTVqDXHvEFurd+/XpgsRL5UnX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.48.0/LICENSE
```

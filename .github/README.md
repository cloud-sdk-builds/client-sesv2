...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Jj1w7E5x1I7YpKSBmKxuki4JmWF+7e9xEAYBuRR1oqJwEH5A+kJh/KUy5un7Ffay
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.16.0/index.min.mjs": "sha384-Jj1w7E5x1I7YpKSBmKxuki4JmWF+7e9xEAYBuRR1oqJwEH5A+kJh/KUy5un7Ffay"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.16.0/LICENSE
```

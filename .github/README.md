...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-VUDxEUI2Tm51/SXPk6IL8Iuxd6WT3D/MZSa8+jWZ0udYdZznvFBaq7KGJJAYSsPb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.651.1/index.min.mjs": "sha384-VUDxEUI2Tm51/SXPk6IL8Iuxd6WT3D/MZSa8+jWZ0udYdZznvFBaq7KGJJAYSsPb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.651.1/LICENSE
```

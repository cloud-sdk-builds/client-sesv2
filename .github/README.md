...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3tNrm9sV9bVt46JIBTrasMejpyKE7QBFjbvKGsetn2pNFmTJInHTgTCVWsUI3sOu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.142.0/index.min.mjs": "sha384-3tNrm9sV9bVt46JIBTrasMejpyKE7QBFjbvKGsetn2pNFmTJInHTgTCVWsUI3sOu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.142.0/LICENSE
```

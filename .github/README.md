...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nFWHssw+akoYdUl6SuOX3Z5dYyCnqGE8WBq8bIKjQ0NN4L2xTeRawch/xBrvm+Va
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.592.0/index.min.mjs": "sha384-nFWHssw+akoYdUl6SuOX3Z5dYyCnqGE8WBq8bIKjQ0NN4L2xTeRawch/xBrvm+Va"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.592.0/LICENSE
```

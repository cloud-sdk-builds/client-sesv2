...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nsj3IOEbgs9aQ2HEKWYXYEpNF87bGcHyMo2fs6UONB2sKp8HuSvweQUgDUdU3rc+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.435.0/index.min.mjs": "sha384-nsj3IOEbgs9aQ2HEKWYXYEpNF87bGcHyMo2fs6UONB2sKp8HuSvweQUgDUdU3rc+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.435.0/LICENSE
```

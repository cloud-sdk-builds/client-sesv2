...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yiJiI09JpKls+kZKNmdcJG1/TcvbnJ4UyHc32sfAKw9mtISr+y+1T7yHYegwBoJY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.194.0/index.min.mjs": "sha384-yiJiI09JpKls+kZKNmdcJG1/TcvbnJ4UyHc32sfAKw9mtISr+y+1T7yHYegwBoJY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.194.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5wbByUxHIsdcOLtA5S7xgVSBb6MYtoX0OhdWexKPA2s+vyq078jx41yHP/GfRXDj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.974.0/index.min.mjs": "sha384-5wbByUxHIsdcOLtA5S7xgVSBb6MYtoX0OhdWexKPA2s+vyq078jx41yHP/GfRXDj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.974.0/LICENSE
```

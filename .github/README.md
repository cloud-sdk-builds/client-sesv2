...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hcmNQJHBriRerbi6CVbrjpYqy3V/aPc0b2D9tZcXmLMZoT7HdXsGZIzPspGMhISu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.804.0/index.min.mjs": "sha384-hcmNQJHBriRerbi6CVbrjpYqy3V/aPc0b2D9tZcXmLMZoT7HdXsGZIzPspGMhISu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.804.0/LICENSE
```

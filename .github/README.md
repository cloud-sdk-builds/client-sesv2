...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lcnIaJAE/wOtJxfcUya3KK0ghjH+A9w5bEeANwMuVGCPyqv9HubJL0gtH3FVFAU+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.590.0/index.min.mjs": "sha384-lcnIaJAE/wOtJxfcUya3KK0ghjH+A9w5bEeANwMuVGCPyqv9HubJL0gtH3FVFAU+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.590.0/LICENSE
```

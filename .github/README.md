...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+yYzKBUyQ43qLpKI4Yiv3E4BKsuUtEMhiLzUG/QJp9V84IawiSQQ4iX6+C/Uc8xF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.511.0/index.min.mjs": "sha384-+yYzKBUyQ43qLpKI4Yiv3E4BKsuUtEMhiLzUG/QJp9V84IawiSQQ4iX6+C/Uc8xF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.511.0/LICENSE
```

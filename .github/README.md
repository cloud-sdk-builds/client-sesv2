...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RoFXA/QioYlSJk+GixxVHPsYpVWdPS2z9X5GSE2pqQovnOcWnyvQ7jAK75yKCKFG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.94.0/index.min.mjs": "sha384-RoFXA/QioYlSJk+GixxVHPsYpVWdPS2z9X5GSE2pqQovnOcWnyvQ7jAK75yKCKFG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.94.0/LICENSE
```

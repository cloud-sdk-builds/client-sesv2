...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7CgNPYn7GWFoIJU5Wn8zdGd/hyOXbNULMrHlBL1lc0w1LTVRJG5qmFOtAXuIRlNJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.81.0/index.min.mjs": "sha384-7CgNPYn7GWFoIJU5Wn8zdGd/hyOXbNULMrHlBL1lc0w1LTVRJG5qmFOtAXuIRlNJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.81.0/LICENSE
```

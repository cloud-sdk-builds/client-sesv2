...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iuRtTYORpomD3V8yWW7sS5do2iKf/6uIgIdZH0r+s9OpTdPeW9O6+XzGKWQ0vQww
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.828.0/index.min.mjs": "sha384-iuRtTYORpomD3V8yWW7sS5do2iKf/6uIgIdZH0r+s9OpTdPeW9O6+XzGKWQ0vQww"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.828.0/LICENSE
```

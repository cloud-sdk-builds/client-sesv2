...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VW/S1XteWD5id/jjVEOOt9kSsSOo9VA97WvF5+yi+so2dv4U5zijlHJYTbbHV77K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.575.0/index.min.mjs": "sha384-VW/S1XteWD5id/jjVEOOt9kSsSOo9VA97WvF5+yi+so2dv4U5zijlHJYTbbHV77K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.575.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0iYDaCqYFsnd/lCOHsGOzWdp9/S5z5j9aMZbVujmnbvdYrqEmcqGG7xnkwuorNfN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.229.0/index.min.mjs": "sha384-0iYDaCqYFsnd/lCOHsGOzWdp9/S5z5j9aMZbVujmnbvdYrqEmcqGG7xnkwuorNfN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.229.0/LICENSE
```

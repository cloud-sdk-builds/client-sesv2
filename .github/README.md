...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qvCLHolcZNIemACAe8p382Mjbe8nxe0dl4R/P8bk0LVC+UomjmUhULb6tPNwzqKD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.92.0/index.min.mjs": "sha384-qvCLHolcZNIemACAe8p382Mjbe8nxe0dl4R/P8bk0LVC+UomjmUhULb6tPNwzqKD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.92.0/LICENSE
```

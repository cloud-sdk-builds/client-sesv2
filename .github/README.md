...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2WD23KnOzdtwEBHxT6P/0mw2abXemep2gLT3MAKm49SGVnndCDjZ1hsZvJEhyQ71
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.930.0/index.min.mjs": "sha384-2WD23KnOzdtwEBHxT6P/0mw2abXemep2gLT3MAKm49SGVnndCDjZ1hsZvJEhyQ71"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.930.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-miOP3ONESJwYUFVrGHB4FD7alcjndVxtH2TY9uPi+ENF+B0k5GRQsFhtNS9FoBVT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.74.0/index.min.mjs": "sha384-miOP3ONESJwYUFVrGHB4FD7alcjndVxtH2TY9uPi+ENF+B0k5GRQsFhtNS9FoBVT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.74.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bfw+SgyDXahOAoMg2W8vnRzhz0x+kxYFs0B1FdYvZUhrkpOiA2G6EWv9Bc9SSjkc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.30.0/index.min.mjs": "sha384-bfw+SgyDXahOAoMg2W8vnRzhz0x+kxYFs0B1FdYvZUhrkpOiA2G6EWv9Bc9SSjkc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.30.0/LICENSE
```

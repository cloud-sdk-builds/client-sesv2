...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aPi6WkrjZNrf4ku+AQPmqmMqYP0NIXLNjcXSeXLNMbEa4vZbQ6y5zb+SnQQgBFLg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.27.0/index.min.mjs": "sha384-aPi6WkrjZNrf4ku+AQPmqmMqYP0NIXLNjcXSeXLNMbEa4vZbQ6y5zb+SnQQgBFLg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.27.0/LICENSE
```

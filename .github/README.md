...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-p4S+4rjdK1jDzsvjX2jpATwAbpDOOMxbQTQTIkXwUKy9dkUnoRtxweYUUQLkl9ty
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.47.1/index.min.mjs": "sha384-p4S+4rjdK1jDzsvjX2jpATwAbpDOOMxbQTQTIkXwUKy9dkUnoRtxweYUUQLkl9ty"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.47.1/LICENSE
```

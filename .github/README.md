...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F9mB+j5nnZfaK2AqufAhO1anKP+EO86QZ26ivLmtSYDBf8wVYURejROk+hNbfRzO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.8.0/index.min.mjs": "sha384-F9mB+j5nnZfaK2AqufAhO1anKP+EO86QZ26ivLmtSYDBf8wVYURejROk+hNbfRzO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.8.0/LICENSE
```

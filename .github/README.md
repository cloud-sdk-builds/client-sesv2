...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YjzonbtPNJXpOtY3p/5N0eGj7EckTgerjkuPNA2BDB2BiyHH5NTYsIGlFQQOzrLN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.817.0/index.min.mjs": "sha384-YjzonbtPNJXpOtY3p/5N0eGj7EckTgerjkuPNA2BDB2BiyHH5NTYsIGlFQQOzrLN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.817.0/LICENSE
```

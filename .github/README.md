...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P3Z2TCzFjAAbvKXjn3EIe7dj9DQVYqlQYf1lMPO2PVkV2Nb9ZXQUxsjalNRUPdcS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.895.0/index.min.mjs": "sha384-P3Z2TCzFjAAbvKXjn3EIe7dj9DQVYqlQYf1lMPO2PVkV2Nb9ZXQUxsjalNRUPdcS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.895.0/LICENSE
```

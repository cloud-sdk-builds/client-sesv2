...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QLQHsA6IOwz3b1oV7HBvPVA0JgwWziqAorKzgxShgQrZsTgz8gIf6Val9ol986pX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.23.0/index.min.mjs": "sha384-QLQHsA6IOwz3b1oV7HBvPVA0JgwWziqAorKzgxShgQrZsTgz8gIf6Val9ol986pX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.23.0/LICENSE
```

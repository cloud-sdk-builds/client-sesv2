...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zOdncIEk7oppnt4fANW+3pZ0aaCqrHiHRGKeoQj7asJECZTjmtLzJPYVU5U04Frd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.231.0/index.min.mjs": "sha384-zOdncIEk7oppnt4fANW+3pZ0aaCqrHiHRGKeoQj7asJECZTjmtLzJPYVU5U04Frd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.231.0/LICENSE
```

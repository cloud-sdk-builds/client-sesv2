...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-aD7CGDhLiotyL5BK7gCIgpPXiVhY+5S7JOAldqJ9MzB/oG1aXIM7UPFpuGbqWgbt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.8.1/index.min.mjs": "sha384-aD7CGDhLiotyL5BK7gCIgpPXiVhY+5S7JOAldqJ9MzB/oG1aXIM7UPFpuGbqWgbt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.8.1/LICENSE
```

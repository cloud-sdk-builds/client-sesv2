...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VDzMlFjo04J2G2/5SQYf8zHmcZwz7LPz+INLaaENR6T2hvuKS3fVLemtLUqzBEXg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.245.0/index.min.mjs": "sha384-VDzMlFjo04J2G2/5SQYf8zHmcZwz7LPz+INLaaENR6T2hvuKS3fVLemtLUqzBEXg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.245.0/LICENSE
```

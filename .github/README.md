...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XhouE8L+cH5zY6ptjpz9dmJA/ji/ZF+nNuvzxkXhAqq1rXz+JpYGI6bALlsOySAu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.154.0/index.min.mjs": "sha384-XhouE8L+cH5zY6ptjpz9dmJA/ji/ZF+nNuvzxkXhAqq1rXz+JpYGI6bALlsOySAu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.154.0/LICENSE
```

...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NEc0HmAMN47lF0AwAC5ZPAYKuKtu+V0z3A193PeCspdmif9xl6a47iIDP4vZHryh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.504.0/index.min.mjs": "sha384-NEc0HmAMN47lF0AwAC5ZPAYKuKtu+V0z3A193PeCspdmif9xl6a47iIDP4vZHryh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.504.0/LICENSE
```

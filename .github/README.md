...
[`@aws-sdk/client-sesv2`](https://www.npmjs.com/package/@aws-sdk/client-sesv2/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZAJlIs7AGj+t7gPPrVf8mp/VRR9yjvl0mbnLxx0Z0RPeuUyZPKVa3Qjo6Qv2KCj/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sesv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sesv2@3.598.0/index.min.mjs": "sha384-ZAJlIs7AGj+t7gPPrVf8mp/VRR9yjvl0mbnLxx0Z0RPeuUyZPKVa3Qjo6Qv2KCj/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sesv2/blob/refs/tags/3.598.0/LICENSE
```
